...
export const metadata = {
  title: "Player Demo | RadiantCastOS",
  description: "Public player demo page (placeholder)."
};
      ...
      <main style={{ ...container(980), ...section }}>
        ...
        <div style={{ ...card }}>
          ...
          <div style={{ marginTop: 18, padding: 16, borderRadius: 16, border: "1px solid rgba(255,255,255,0.10)", background: "rgba(0,0,0,0.22)" }}>
            ...
            {/* Minimal HTML5 playback (works for audio streams; HLS in browsers depends on format) */}
